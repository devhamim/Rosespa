...
class FrontendController extends Controller
{
    ...
    function service_details($id){
        ...
        return view('frontend.services_dtails',[
            'services'=>$services,
    ...
    function makeReservation(Request $request){
        ...
        $whatsappURL = 'https://api.whatsapp.com/send?phone=88' . $setting->first()->number;
        $whatsappURL .= '&text=Hello,';
        $whatsappURL .= '%20Name:%20' . $request->input('name');
        $whatsappURL .= '%20Phone:%20' . $request->input('phone');
        $whatsappURL .= '%20Email:%20' . $request->input('email');
        $whatsappURL .= '%20Date:%20' . $request->input('date');
        $whatsappURL .= '%20Service:%20' . $request->input('beauty-service');
        $whatsappURL .= '%20Expert:%20' . $request->input('beauty-expart');
        $whatsappURL .= '%20Message:%20' . $request->input('msg-area');
